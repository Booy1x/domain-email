  ...
  fetch('/api/emails/' + id)
    ...
    .then(function(email) {
      ...
      if (hasHtml) {
        ...
        body = '<div class="email-iframe-wrap"><iframe id="' + iframeId + '" class="email-iframe" sandbox="allow-scripts allow-top-navigation-by-user-activation allow-popups" frameborder="0" style="width:100%;border:0;box-shadow:none;display:block;min-height:200px;max-height:80vh;overflow:auto;" srcdoc="' + srcdocContent.replace(/&/g,'&amp;').replace(/"/g,'&quot;') + '"></iframe></div>';
